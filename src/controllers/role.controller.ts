...
export class RoleController {
  ...
  create = asyncHandler(async (req: Request, res: Response) => {
    ...
    sendSuccessResponse(res, { data: role, resourceKey: 'role', message: 'Role created successfully', statusCode: 201 });
  });
  ...
  getAll = asyncHandler(async (req: Request, res: Response) => {
    ...
    sendSuccessResponse(res, { data: roles, resourceKey: 'roles', message: 'Roles retrieved successfully', pagination });
  });

  getRoleNames = asyncHandler(async (_req: Request, res: Response) => {
    const roles = await this.service.getAllRoleNames();
    sendSuccessResponse(res, { data: roles, resourceKey: 'roles', message: 'Role names retrieved successfully' });
  });

  update = asyncHandler(async (req: Request, res: Response) => {
    const role = await this.service.updateRole(getIdParam(req), req.body);
    sendSuccessResponse(res, { data: role, resourceKey: 'role', message: 'Role updated successfully' });
  });

  delete = asyncHandler(async (req: Request, res: Response) => {
    await this.service.deleteRole(getIdParam(req));
    sendSuccessResponse(res, { data: null, message: 'Role deleted successfully' });
  });
}
